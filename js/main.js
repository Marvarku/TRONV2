...
(function($) {
    ...
    * ------------------------------------------------------ */
    ...
    document.addEventListener("scroll", function() {
        const slideInText = document.querySelector(".slide-in");
        const rect = slideInText.getBoundingClientRect();
        if (rect.top < window.innerHeight) {
            slideInText.classList.add("visible");
        }
    });

    document.addEventListener("scroll", function() {
        const slideInRightText = document.querySelector(".slide-in-right");
        const rect = slideInRightText.getBoundingClientRect();
        if (rect.top < window.innerHeight) {
            slideInRightText.classList.add("visible");
        }
    });
